...
public class TtsHelper implements SynthesisCallback {
    ...
    public final void generateAudioFile(String text) {
        this.textQueue.offer(text);
    ...
    public void setAudioFileGenerationCallback(AudioFileGenerationCallback callback) {
        this.audioFileGenerationCallback = callback;
    }
    ...
    private final void writeToFile(byte[] data) {
        try {
            ...
            if (file != null) {
                ...
                if (audioFileGenerationCallback != null) {
                    audioFileGenerationCallback.onAudioFileGenerationEnd(file.getName());
                }
            }
